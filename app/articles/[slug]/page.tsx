...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return {
    ...
    alternates: { canonical: `${siteConfig.url}/articles/${article.slug}` },
    openGraph: { type: "article", title: article.title, description: article.abstract, url: `${siteConfig.url}/articles/${article.slug}` },
    other: {
      citation_title: article.title,
      citation_pdf_url: `${siteConfig.url}/articles/${article.slug}/pdf`,
      citation_publication_date: article.publicationDate || "",
      citation_author: (article.authors || []).map((author) => author.fullName)
    }
  };
}
